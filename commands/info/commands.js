module.exports = {
    ...
    run(message, args, client, lang) {
        ...
        .addFields(
            ...
            {name: client.languages.__({phrase: 'commands.fun', locale: lang}), value: "```8Ball , Ascii , CoinFlip , Say , Sharpen , Trigger , Ohno , Rainbow , Shit , Trash , Wanted , Wasted, Blush, Cry, Dance, Hug, Kiss, Mirror, Rip, Yaoi, Yuri```"},
